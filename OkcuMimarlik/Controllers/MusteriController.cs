...
public class MusteriController : Controller
{
  ...
  public async Task<IActionResult> MusteriListesi(string searchString)
  {
    ...
    if (!String.IsNullOrEmpty(searchString))
    {
      ...
      musteriler = musteriler.Where(m => m.AdSoyad != null && m.AdSoyad.IndexOf(searchString, StringComparison.OrdinalIgnoreCase) >= 0).ToList();
